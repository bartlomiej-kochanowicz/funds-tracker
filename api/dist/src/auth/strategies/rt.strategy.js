    ...
    constructor() {
        super({
            jwtFromRequest: passport_jwt_1.ExtractJwt.fromExtractors([
                (request) => {
                    const data = request === null || request === void 0 ? void 0 : request.cookies.refreshToken;
                    if (!data) {
                        return null;
                    }
                    return data;
            ...
            secretOrKey: env_1.RT_SECRET,
            passReqToCallback: true,
        });
    }
    validate(req, payload) {
        return Object.assign(Object.assign({}, payload), { refreshToken: req.cookies.refreshToken });
    }
};
