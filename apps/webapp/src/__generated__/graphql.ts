...
export type ConfirmSignupMutation = {
	__typename?: "Mutation";
	confirmSignup: { __typename?: "ConfirmSignup"; success: boolean };
};
...
export type LogoutMutation = {
	__typename?: "Mutation";
	logout: { __typename?: "Logout"; success: boolean };
};
...
export type RefreshTokenMutation = {
	__typename?: "Mutation";
	refreshToken: { __typename?: "Refresh"; success: boolean };
};
...
export type ResetPasswordMutation = {
	__typename?: "Mutation";
	resetPassword: { __typename?: "ResetPassword"; success: boolean };
};
...
export type SendCodeMutation = {
	__typename?: "Mutation";
	sendCode: { __typename?: "SendCode"; success: boolean };
};
...
export type SetNewPasswordMutation = {
	__typename?: "Mutation";
	setNewPassword: { __typename?: "SetNewPassword"; success: boolean };
};
...
export type SigninMutation = {
	__typename?: "Mutation";
	signinLocal: { __typename?: "SigninLocal"; success: boolean };
};
...
export type SignupMutation = {
	__typename?: "Mutation";
	signupLocal: { __typename?: "SignupLocal"; success: boolean };
};
...
export type AddFundsToCashAccountMutation = {
	__typename?: "Mutation";
	addFundsToCashAccount: { __typename?: "CashAccount"; balance: number };
};
...
export type DeleteCashAccountMutation = {
	__typename?: "Mutation";
	deleteCashAccount: { __typename?: "CashAccountDelete"; success: boolean };
};
...
export type UpdateCashAccountMutation = {
	__typename?: "Mutation";
	updateCashAccount: { __typename?: "CashAccount"; uuid: string; name: string };
};
...
export type IntroductionCreateCashAccountsMutation = {
	__typename?: "Mutation";
	introductionCreateCashAccounts: { __typename?: "IntroductionCashAccounts"; success: boolean };
};
...
export type IntroductionCreatePortfoliosMutation = {
	__typename?: "Mutation";
	introductionCreatePortfolios: { __typename?: "IntroductionPortfolios"; success: boolean };
};
...
export type CreatePortfolioMutation = {
	__typename?: "Mutation";
	createPortfolio: { __typename?: "Portfolio"; uuid: string; name: string };
};
...
export type DeletePortfolioMutation = {
	__typename?: "Mutation";
	deletePortfolio: { __typename?: "PortfolioDelete"; success: boolean };
};
...
export type UpdatePortfolioMutation = {
	__typename?: "Mutation";
	updatePortfolio: { __typename?: "Portfolio"; uuid: string; name: string };
};
...
export type GetCashAccountOperationsQuery = {
	__typename?: "Query";
	cashAccount: {
		__typename?: "CashAccount";
		operations: Array<{
...
export type GetCashAccountsQuery = {
	__typename?: "Query";
	cashAccounts: Array<{
		__typename?: "CashAccount";
		uuid: string;
...
export type EmailExistQuery = {
	__typename?: "Query";
	emailExist: { __typename?: "Email"; exist: boolean };
};
...
export type GetInstrumentHistoryQuery = {
	__typename?: "Query";
	instrumentHistory: Array<{
		__typename?: "InstrumentHistory";
		date: string;
		open: number;
		close: number;
...
export type GetPortfoliosQuery = {
	__typename?: "Query";
	portfolios: Array<{ __typename?: "Portfolio"; uuid: string; name: string }>;
};
			...
			variableDefinitions: [
				{
					...
					type: {
						kind: "NonNullType",
						type: { kind: "NamedType", name: { kind: "Name", value: "ConfirmSignupInput" } },
					},
				},
			],
			selectionSet: {
...
} as unknown as DocumentNode<ConfirmSignupMutation, ConfirmSignupMutationVariables>;
			...
			variableDefinitions: [
				{
					...
					type: {
						kind: "NonNullType",
						type: { kind: "NamedType", name: { kind: "Name", value: "SendCodeInput" } },
					},
				},
			],
			selectionSet: {
			...
			variableDefinitions: [
				{
					...
					type: {
						kind: "NonNullType",
						type: { kind: "NamedType", name: { kind: "Name", value: "SetNewPasswordInput" } },
					},
				},
			],
			selectionSet: {
	...
	definitions: [
		{
			...
			selectionSet: {
				...
				selections: [
					{
						kind: "Field",
						name: { kind: "Name", value: "signinLocal" },
						arguments: [
							{
								kind: "Argument",
								name: { kind: "Name", value: "data" },
	...
	definitions: [
		{
			...
			selectionSet: {
				...
				selections: [
					{
						kind: "Field",
						name: { kind: "Name", value: "signupLocal" },
						arguments: [
							{
								kind: "Argument",
								name: { kind: "Name", value: "data" },
	...
	definitions: [
		{
			kind: "OperationDefinition",
			operation: "mutation",
			name: { kind: "Name", value: "AddFundsToCashAccount" },
			variableDefinitions: [
				{
					kind: "VariableDefinition",
					variable: { kind: "Variable", name: { kind: "Name", value: "data" } },
					type: {
						...
						type: {
							kind: "NamedType",
							name: { kind: "Name", value: "AddFundsToCashAccountInput" },
						},
					},
				},
			],
				...
				selections: [
					{
						...
						selectionSet: {
							kind: "SelectionSet",
							selections: [{ kind: "Field", name: { kind: "Name", value: "balance" } }],
						},
					},
				],
			},
...
} as unknown as DocumentNode<AddFundsToCashAccountMutation, AddFundsToCashAccountMutationVariables>;
export const CreateCashAccountDocument = {
	kind: "Document",
	definitions: [
		{
			kind: "OperationDefinition",
			operation: "mutation",
			name: { kind: "Name", value: "CreateCashAccount" },
			variableDefinitions: [
				{
					kind: "VariableDefinition",
					variable: { kind: "Variable", name: { kind: "Name", value: "data" } },
					type: {
						kind: "NonNullType",
						type: { kind: "NamedType", name: { kind: "Name", value: "CreateCashAccountInput" } },
					},
				},
			],
			selectionSet: {
...
} as unknown as DocumentNode<CreateCashAccountMutation, CreateCashAccountMutationVariables>;
export const DeleteCashAccountDocument = {
	kind: "Document",
	definitions: [
		{
			kind: "OperationDefinition",
...
} as unknown as DocumentNode<DeleteCashAccountMutation, DeleteCashAccountMutationVariables>;
export const UpdateCashAccountDocument = {
	kind: "Document",
	definitions: [
		{
			kind: "OperationDefinition",
			...
			variableDefinitions: [
				...
				},
				{
					...
					type: {
						kind: "NonNullType",
						type: { kind: "NamedType", name: { kind: "Name", value: "UpdateCashAccountInput" } },
					},
				},
			],
			selectionSet: {
...
} as unknown as DocumentNode<UpdateCashAccountMutation, UpdateCashAccountMutationVariables>;
				...
				selections: [
					{
						...
						selectionSet: {
							...
							selections: [
								...
								{ kind: "Field", name: { kind: "Name", value: "introductionStep" } },
...
export const IntroductionCreateCashAccountsDocument = {
	kind: "Document",
	definitions: [
		{
			kind: "OperationDefinition",
			operation: "mutation",
			name: { kind: "Name", value: "IntroductionCreateCashAccounts" },
			variableDefinitions: [
				{
					kind: "VariableDefinition",
					variable: { kind: "Variable", name: { kind: "Name", value: "data" } },
					type: {
						...
						type: {
							kind: "NamedType",
							name: { kind: "Name", value: "IntroductionCreateCashAccountsInput" },
						},
					},
				},
			],
...
>;
export const IntroductionCreatePortfoliosDocument = {
	kind: "Document",
	definitions: [
		{
			kind: "OperationDefinition",
			...
			variableDefinitions: [
				{
					...
					type: {
						...
						type: {
							kind: "NamedType",
							name: { kind: "Name", value: "IntroductionCreatePortfoliosInput" },
						},
					},
				},
			],
			...
			variableDefinitions: [
				{
					...
					type: {
						kind: "NonNullType",
						type: { kind: "NamedType", name: { kind: "Name", value: "CreatePortfolioInput" } },
					},
				},
			],
			selectionSet: {
...
} as unknown as DocumentNode<CreatePortfolioMutation, CreatePortfolioMutationVariables>;
...
} as unknown as DocumentNode<DeletePortfolioMutation, DeletePortfolioMutationVariables>;
	...
	definitions: [
		{
			...
			variableDefinitions: [
				...
				},
				{
					...
					type: {
						kind: "NonNullType",
						type: { kind: "NamedType", name: { kind: "Name", value: "UpdatePortfolioInput" } },
					},
				},
			],
			selectionSet: {
...
} as unknown as DocumentNode<UpdatePortfolioMutation, UpdatePortfolioMutationVariables>;
	...
	definitions: [
		{
			kind: "OperationDefinition",
			operation: "query",
			name: { kind: "Name", value: "GetCashAccountOperations" },
			variableDefinitions: [
				{
					kind: "VariableDefinition",
					variable: { kind: "Variable", name: { kind: "Name", value: "uuid" } },
...
} as unknown as DocumentNode<GetCashAccountOperationsQuery, GetCashAccountOperationsQueryVariables>;
export const GetCashAccountsDocument = {
	kind: "Document",
	definitions: [
		{
			kind: "OperationDefinition",
			operation: "query",
			name: { kind: "Name", value: "GetCashAccounts" },
			selectionSet: {
				kind: "SelectionSet",
				selections: [
					{
						kind: "Field",
						name: { kind: "Name", value: "cashAccounts" },
						selectionSet: {
							kind: "SelectionSet",
							selections: [
								{ kind: "Field", name: { kind: "Name", value: "uuid" } },
...
} as unknown as DocumentNode<GetCashAccountsQuery, GetCashAccountsQueryVariables>;
export const EmailExistDocument = {
	kind: "Document",
	definitions: [
		{
			kind: "OperationDefinition",
			operation: "query",
			name: { kind: "Name", value: "EmailExist" },
			variableDefinitions: [
				{
					kind: "VariableDefinition",
					variable: { kind: "Variable", name: { kind: "Name", value: "data" } },
				...
				selections: [
					{
						...
						selectionSet: {
							kind: "SelectionSet",
							selections: [{ kind: "Field", name: { kind: "Name", value: "exist" } }],
						},
					},
				],
			},
...
} as unknown as DocumentNode<EmailExistQuery, EmailExistQueryVariables>;
...
export const GetInstrumentHistoryDocument = {
	kind: "Document",
	definitions: [
		{
			kind: "OperationDefinition",
			operation: "query",
			name: { kind: "Name", value: "GetInstrumentHistory" },
			variableDefinitions: [
				{
					kind: "VariableDefinition",
					variable: { kind: "Variable", name: { kind: "Name", value: "data" } },
					type: {
						kind: "NonNullType",
						type: { kind: "NamedType", name: { kind: "Name", value: "InstrumentHistoryInput" } },
					},
				},
			],
			selectionSet: {
...
} as unknown as DocumentNode<GetInstrumentHistoryQuery, GetInstrumentHistoryQueryVariables>;
			...
			variableDefinitions: [
				{
					...
					type: {
						kind: "NonNullType",
						type: { kind: "NamedType", name: { kind: "Name", value: "SearchInstrumentInput" } },
					},
				},
			],
			selectionSet: {
				...
				selections: [
					{
						...
						selectionSet: {
							...
							selections: [
								...
								{ kind: "Field", name: { kind: "Name", value: "previousClose" } },
								{ kind: "Field", name: { kind: "Name", value: "previousCloseDate" } },
							],
						},
					},
				],
...
} as unknown as DocumentNode<SearchInstrumentQuery, SearchInstrumentQueryVariables>;
