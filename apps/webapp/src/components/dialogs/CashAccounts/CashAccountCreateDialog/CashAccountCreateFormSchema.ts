import { CashAccountCreateInput, Currency } from "__generated__/graphql";
...
export const CashAccountCreateFormSchema = object<CashAccountCreateInput>().shape({
	...
	currency: mixed<Currency>().oneOf(Object.values(Currency)).required(EMPTY_VALIDATION_MESSAGE),
});
