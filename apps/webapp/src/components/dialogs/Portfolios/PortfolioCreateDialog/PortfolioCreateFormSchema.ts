...
export const PortfolioCreateFormSchema = object<PortfolioCreateInput>().shape({
	name: string()
...
export type PortfolioCreateFormSchemaType = InferType<typeof PortfolioCreateFormSchema>;
