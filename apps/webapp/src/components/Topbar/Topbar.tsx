...
export const Topbar = () => (
	<header className="fixed inset-x-0 top-0 z-10 flex w-full flex-wrap border-b border-gray-300 bg-white py-2.5 text-sm md:py-4 dark:border-neutral-700 dark:bg-zinc-800">
		<nav className="mx-auto flex w-full basis-full items-center justify-between px-4 md:justify-end md:px-8">
			<Link
				to={ROUTES.HOME}
				className="md:hidden dark:outline-blue-800"
			>
