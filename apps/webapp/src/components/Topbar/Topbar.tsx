...
export const Topbar = () => (
	<header className="fixed inset-x-0 top-0 z-10 flex w-full flex-wrap border-b border-gray-300 bg-white py-2.5 text-sm dark:border-neutral-700 dark:bg-zinc-800 md:py-4">
