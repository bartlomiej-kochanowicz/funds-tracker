    ...
    <div style="margin: 0 auto;max-width: 550px;width: 90%;">
      <div style="margin: 0 auto;width: 400px;height: auto;">
        <a href="https://funds-tracker.com/" style="margin: 0;">
          <img src="https://www.funds-tracker.com/favicon.svg" style="margin: 0;width: 400px;height: auto;padding: 24px 0;" >
        </a>
      </div>
      ...
      <div style="margin: 0;margin-top: 4px;padding: 24px;background-color: rgb(255, 255, 255);border-radius: 6px;">
        <p>Hello {{name}},</p>
