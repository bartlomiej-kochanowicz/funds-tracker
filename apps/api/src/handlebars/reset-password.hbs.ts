...
<html>
  ...
  <body>
    <div class="wrapper">
      ...
      <div class="wrapper__heading">Reset pasword</div>
      ...
      <div class="content-wrapper">
        ...
        <a class="content-wrapper__paragraph-small">
          If you don't want to change your password, just ignore this message.
        </p>
      </div>

      <p class="content-wrapper__paragraph-small">
        This email was sent to <a href="mailto:{{email}}" class="color-blue">{{email}}</a> because you are a registered Funds Tracker user.
      </p>
